...
#Recibe dos valores, mosaicoX y mosaicoY que definen que tan grande seran los mosaicos, se recorre la imagen con estos valores.
#En cada mosaico sacamos el promedio de los valores rojo, verde y azul de cada pixel, con esto se aplica ese valor a cada componente de los pixeles del mosaico
